<template>
  <v-col>
    <div class="py-3 px-2">
      ...
      <v-row justify="center">
        <v-img src="../assets/privacy.svg" max-width="600"></v-img>
      </v-row>
      ...
      <p>
        1- Account means a unique account created for You to access our Service
        or parts of our Service.
      </p>
      <p>
        2- Affiliate means an entity that controls, is controlled by or is under
        common control with a party, where "control" means ownership of 50% or
        more of the shares, equity interest or other securities entitled to vote
        for election of directors or other managing authority.
      </p>
      <p>
        3- Application means the software program provided by the Company
        downloaded by You on any electronic device, named Auto
      </p>
      <p>
        4- Company (referred to as either "the Company", "We", "Us" or "Our" in
        this Agreement) refers to Auto, Iraq Baghdad
      </p>
      <p>5 - Country refers to: Iraq</p>
      <p>
        6- Device means any device that can access the Service such as a
        computer, a cellphone or a digital tablet.
      </p>
      <p>
        7- Personal Data is any information that relates to an identified or
        identifiable individual.
      </p>
      <p>8- Service refers to the Application.</p>
      <p>
        9- Service Provider means any natural or legal person who processes the
      ...
      <p>
        10- Usage Data refers to data collected automatically, either generated
      ...
      <h1 class="h1">Collecting and Using Your Personal Data</h1>
      ...
      <p>
        2- To manage Your Account: to manage Your registration as a user of the
      ...
      <p>
        1- With Service Providers: We may share Your personal information with
      ...
      <p>
        3- With Affiliates: We may share Your information with Our affiliates,
      ...
      <p>
        6- With Your consent: We may disclose Your personal information for any
      ...
      <p class="pl-5">By email: info@autodemand.app</p>
    </div>
  </v-col>
</template>
<style>
